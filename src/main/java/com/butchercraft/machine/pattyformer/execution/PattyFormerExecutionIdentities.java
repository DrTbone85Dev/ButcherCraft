...
final class PattyFormerExecutionIdentities {
    private PattyFormerExecutionIdentities() {
    }

    static String inputIdentity(List<ItemStack> inputs) {
        CanonicalDigest digest = CanonicalDigest.create("butchercraft:patty_former_input_identity")
                .add(inputs.size());
    ...
    static String expectedOutputIdentity(List<Product> expectedOutputs) {
        CanonicalDigest digest = CanonicalDigest.create("butchercraft:patty_former_expected_output_identity")
    ...
    static String operationIdentity(ResolvedWorkstationOperation operation) {
        CanonicalDigest digest = CanonicalDigest.create("butchercraft:patty_former_operation_identity")
    ...
    static String sourceFreshnessIdentity(
        ...
        String digest = CanonicalDigest.create("butchercraft:patty_former_slot_freshness")
