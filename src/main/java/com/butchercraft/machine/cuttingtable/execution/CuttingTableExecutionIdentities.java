...
final class CuttingTableExecutionIdentities {
    private CuttingTableExecutionIdentities() {
    }

    static String inputIdentity(List<ItemStack> inputs) {
        CanonicalDigest digest = CanonicalDigest.create("butchercraft:cutting_table_input_identity")
                .add(inputs.size());
    ...
    static String expectedOutputIdentity(List<Product> expectedOutputs) {
        CanonicalDigest digest = CanonicalDigest.create("butchercraft:cutting_table_expected_output_identity")
    ...
    static String operationIdentity(ResolvedWorkstationOperation operation) {
        CanonicalDigest digest = CanonicalDigest.create("butchercraft:cutting_table_operation_identity")
        ...
        operation.definition().operation().workstationCapability()
                .ifPresentOrElse(capability -> digest.add(capability.toString()), () -> digest.add(""));
    ...
    static String sourceFreshnessIdentity(
        ...
        String digest = CanonicalDigest.create("butchercraft:cutting_table_slot_freshness")
