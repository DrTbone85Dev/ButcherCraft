...
public enum WorkstationReservationFailureCode {
    ...
    OPERATOR_ALREADY_RESERVED("operator_already_reserved"),
    HANDLER_ALREADY_RESERVED("handler_already_reserved"),
    LEGACY_EXCLUSIVE_CONFLICT("legacy_exclusive_conflict"),
    INVALID_HANDLER_TRANSFER("invalid_handler_transfer"),
    WORKSTATION_INSTANCE_CONFLICT("workstation_instance_conflict"),
