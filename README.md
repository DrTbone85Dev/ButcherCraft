...
The trim, ground, forequarter, and beef fabrication products are development-stage product data fixtures. Promoted Grinder products appear in the ButcherCraft creative tab with dedicated placeholder product textures; broader fabrication fixtures still use shared development presentation until separately promoted. They are not food, commerce products, or final balance.
