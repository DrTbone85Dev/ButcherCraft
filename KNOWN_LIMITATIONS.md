...
- Machine wear, damage, lubrication, maintenance, breakdown, and dry-running damage behavior are not implemented. DG-006 architecture/design may begin following IM-032 acceptance; no DG-006 proposal or implementation has begun in this closeout, and runtime implementation remains unauthorized.
...
- Workforce definitions describe positions, staffing requirements, qualifications, and shift assignments. Department records describe Workforce-owned department identities and anchors. Employee records describe individual employment state, department assignment, and a linked in-world employee representation. IM-032B supersedes the normal IM-027 trigger with finite persistent Grinder and Patty Former assignments; IM-028B/IM-029 retain the two explicit one-item transfer routes and IM-030B permits withdrawal from larger source stacks. Workforce still does not provide job claiming, additional transport routes or player-selected transfer quantities, employee inventory, automatic workstation selection, hiring markets, payroll, productivity, Production-driven assignment, general Logistics, autonomous production, or multi-machine tending.
...
- IM-031A provides persistent Machine Run and Workstation operating-state infrastructure; IM-031B/IM-031C activate it for player control, and IM-032B lets finite Workforce assignments request canonical exact-Run START/STOP for the Grinder and Patty Former. Each cycle remains separately bounded and each workstation retains recipe and inventory authority. The Cutting Table remains discrete. Automatic employee RESUME, forced chunk loading, wear, damage, lubrication, maintenance, breakdown, multi-machine tending, and Production machine control remain gated.
