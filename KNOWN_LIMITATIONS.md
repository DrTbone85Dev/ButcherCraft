...
- World Identity currently generates and persists region, county, settlement, and commercial property identity only. The region catalog, naming profiles, manufacturer catalog, and property records do not create business identities, settlement interfaces, regional demand, road names, purchasing, inspections, taxes, or economy behavior.
