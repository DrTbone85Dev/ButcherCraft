...
- Player Legacy is pure starting-scenario template architecture only. It does not generate player save data, character creation, UI, career progression, player ownership, finances, equipment ownership, inheritance gameplay, supplier contracts, relationships as gameplay, employees, customers, inspections, quests, commands, or multi-generation systems.
