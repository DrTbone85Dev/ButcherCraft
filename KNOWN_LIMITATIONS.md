...
- The transformation schema is validated in pure Java, but serialization field names, schema migrations, external metadata policy, and datapack error-reporting are not implemented yet.
