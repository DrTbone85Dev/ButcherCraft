...
- Workforce definitions describe positions, staffing requirements, qualifications, and shift assignments. Department records describe Workforce-owned department identities and anchors. Employee records describe individual employment state, department assignment, and a linked in-world employee representation. IM-027 permits one reservation-scoped Beef Trim Grinder request and IM-028B permits one explicit Cutting Table-to-Grinder Beef Trim transfer with visible carrying. Workforce still does not provide job claiming, Patty Former operation or transport, additional transported materials or quantities, employee inventory, automatic workstation selection, hiring markets, payroll, productivity, Production-driven assignment, general Logistics, or autonomous workflows.
