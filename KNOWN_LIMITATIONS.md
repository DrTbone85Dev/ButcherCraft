...
- Workforce definitions describe positions, staffing requirements, qualifications, and shift assignments. Department records describe Workforce-owned department identities and anchors. Employee records now describe individual employment state, department assignment, and a linked in-world employee representation. Workstation reservations describe exclusive movement targets only. Workforce still does not provide job claiming, workstation operation, item carrying, hiring markets, payroll, productivity, scheduling workers, Production task assignment, economy, inspections, GUI, networking, or automation effects.
