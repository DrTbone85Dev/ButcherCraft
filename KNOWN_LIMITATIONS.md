...
- World Identity currently generates and persists region, county, settlement, commercial property, business, family, historical person, and ownership identity only. The region catalog, naming profiles, manufacturer catalog, property records, business records, and ownership records do not create settlement interfaces, regional demand, road names, purchasing, inspections, taxes, economy behavior, employees, customers, supplier contracts, family legacy starts, NPCs, or player ownership.
