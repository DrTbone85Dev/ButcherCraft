...
- Version 0.6.0 begins the pure Java Material Transformation Engine foundation. Version 0.6.1 migrates only the Grinder to capability-based transformation execution. Version 0.6.2 adds an immutable transformation registry and registers built-in Grinder transformations in Java. Version 0.6.3 formalizes the canonical transformation definition schema. Version 0.6.4 adds a pure Java product definition foundation for the six current Grinder products. Version 0.6.5 adds a pure Java transformation serialization contract. Version 0.6.6 adds pure Java atomic multi-output transformation transactions. It does not migrate datapack registries, Bandsaw behavior, smoker behavior, packaging behavior, cooler behavior, menus, screens, or product data components.
...
- The product definition registry is pure Java and currently covers only the six Grinder products. It does not replace ItemStack product data, datapack-backed processing product definitions, product-to-item mappings, storage rules, spoilage, packaging, or quality expansion.
