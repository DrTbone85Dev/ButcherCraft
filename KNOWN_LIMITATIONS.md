...
- The World Simulation Clock persists infrastructure time state in `<world>/butchercraft/simulation_state.json`, but it does not yet schedule production, deliveries, inspections, business hours, maintenance, refrigeration, economy, reputation, workers, UI, commands, or gameplay events.
