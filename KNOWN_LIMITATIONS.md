...
- Product and transformation datapack loaders validate the current proof content, but schema migrations, datapack-driven category catalogs, full fabrication catalogs, and dynamic product-to-item creation rules are not implemented yet.
