...
- Workforce definitions describe positions, staffing requirements, qualifications, and shift assignments. Department records describe Workforce-owned department identities and anchors. Employee records describe individual employment state, department assignment, and a linked in-world employee representation. IM-027 permits one transient, reservation-scoped Beef Trim Grinder request and completion observation without changing employee or reservation persistence. Workforce still does not provide job claiming, general workstation operation, Patty Former operation, additional employee recipes, item carrying, hiring markets, payroll, productivity, scheduling workers, Production task assignment, economy, inspections, GUI, networking, or autonomous workflow effects.
