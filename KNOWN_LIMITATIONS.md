...
- World Identity currently generates and persists region, county, and settlement identity only. The region catalog and naming profiles do not create commercial properties, manufacturers, business identities, settlement interfaces, regional demand, road names, or economy behavior.
