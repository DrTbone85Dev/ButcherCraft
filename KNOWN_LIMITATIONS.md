...
- The promoted Grinder trim/ground product items for Beef, Pork, Chicken, Buffalo, Lamb, and Venison carry product data and dedicated placeholder presentation, but they provide no food, commerce, upstream sourcing, or world behavior outside the temporary workstation and Grinder processing paths.
...
- The built-in Grinder definition dataset is promoted gameplay content used to prove registry loading, graph validation, generic Grinder resolution, Execution identity, Scheduler dispatch, Production observation, and owner-result evidence across six recipes. Its duration, yield, quality adjustment, thresholds, and acquisition path are still development-stage balance.
