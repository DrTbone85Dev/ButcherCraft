...
- World Identity currently generates and persists region, county, settlement, commercial property, and business identity only. The region catalog, naming profiles, manufacturer catalog, property records, and business records do not create settlement interfaces, regional demand, road names, purchasing, inspections, taxes, economy behavior, employees, customers, supplier contracts, family legacy starts, or player ownership.
