...
- IM-031A provides persistent Machine Run and Workstation operating-state infrastructure only. Grinder and Patty Former still use explicit one-cycle player requests; continuous cycling, GUI START/STOP controls, employee START/STOP, automatic restart, forced chunk loading, wear, maintenance, and Production machine control remain gated.
