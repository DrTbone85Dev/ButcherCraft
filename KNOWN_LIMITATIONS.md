...
- IM-023 adds Workforce-owned Employee Identity, Employment Records, shift-bound presence observation, a narrow linked Employee entity, employee diagnostics, and `employee_records.json` persistence. It does not add workstation operation, job claiming, item carrying, logistics, machine reservation, Production task assignment, payroll, wages, overtime, breaks, morale, fatigue, productivity, training, customer interaction, attendance penalties, Allocation integration, public workforce APIs, startup recovery, checkpoints, or operator reconciliation.
...
- Workforce definitions describe positions, staffing requirements, qualifications, and shift assignments. Employee records now describe individual employment state and a linked in-world employee representation. Workforce still does not provide worker AI, job claiming, workstation operation, item carrying, hiring markets, payroll, productivity, scheduling workers, Production task assignment, economy, inspections, GUI, networking, or automation effects.
