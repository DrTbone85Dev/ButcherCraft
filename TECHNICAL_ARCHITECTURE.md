...
- Employee employment state and department assignment belong in Workforce-owned employee records. Employee entities persist only a stable Employee Identity link and movement anchor; they are not the authoritative employment or department record. Future skill systems require a separate approved owner or explicit Workforce record extension.
