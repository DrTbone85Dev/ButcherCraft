...
- Version 0.8.0 provides the Packaging Table block, inventory foundation, retail product framework, and physical packaging supply items only; packaged-product gameplay remains future core work.
