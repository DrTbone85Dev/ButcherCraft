...
This note records the first generic Execution runtime implementation slice. It does not change RFC-0023, ADR status, gameplay behavior, Allocation integration, or public extension contracts.
...
- Workstation or player-facing invocation.
